    ...
    const sliderSettings = {
        ...
        speed: 5000,
        arrows: false,
        slidesToShow: 5, // Changed from 3 to 4
        slidesToScroll: 1,
        autoplay: true, // Enable automatic sliding
        autoplaySpeed: 0, // Slower movement (5000ms = 5 seconds per slide)
        pauseOnHover: true, // Pause sliding when hovered
        responsive: [
        {
            breakpoint: 1024,
            settings: {
            slidesToShow: 3, // Adjusted for responsiveness
            slidesToScroll: 1,
            }
        },
        {
            breakpoint: 768, // Adjusted breakpoint for better responsiveness
            settings: {
            slidesToShow: 2,
            slidesToScroll: 1
            }
        ...
        {
            breakpoint: 480, // Added for smaller screens
            settings: {
            slidesToShow: 1,
            slidesToScroll: 1
            }
